...
check "$(echo "LeetCode" | egg "'leetify'")"            "1337C0d3"
check "$(echo "hello, world!" | egg "x'o, world'")"     "hell!"
check "$(echo "aaxyxbbxyxcc" | egg "|'xyx'u")"          "AAxyxBBxyxCC"
check "$(echo "hello, world!" | egg "x', world'u")"     "HELLO!"
